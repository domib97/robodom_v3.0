...
try:
    ...
    print(f"Number of buttons: {joystick.get_numbuttons()}")  # Debug info
except pygame.error:
...
while running:
    ...
    # Get button values - Updated Y button index
    ...
    button_y = joystick.get_button(4)  # Y Button (top) - Changed from 2 to 4

    # Debug info - print button states
    print(f"A: {button_a}, B: {button_b}, X: {button_x}, Y: {button_y}")
